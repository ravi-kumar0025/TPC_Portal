...
import coverImage from '../assets/premium_photo-1683880731792-39c07ceea617.avif';
...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex selection:bg-blue-100 selection:text-blue-900 dark:selection:bg-slate-700 dark:selection:text-slate-100">
            {/* Image Side */}
            <div className="hidden lg:block lg:w-1/2 relative bg-slate-900">
                <img src={coverImage} alt="Workspace" className="absolute inset-0 w-full h-full object-cover opacity-90" />
                <div className="absolute inset-0 bg-blue-900/20 mix-blend-multiply"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent"></div>
            </div>

            {/* Login Box Side */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 bg-[#FDFBF7] dark:bg-stone-950 relative">
                ...
                <div className="absolute top-0 w-full h-1/2 inset-0 -z-10 bg-[radial-gradient(#d6d3d1_1px,transparent_1px)] dark:bg-[radial-gradient(#292524_1px,transparent_1px)] [background-size:16px_16px] opacity-60"></div>
                ...
                <div className="max-w-md w-full">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-3 text-slate-500 font-medium dark:text-slate-400">Log in to your CCDC account</p>
                    </div>
