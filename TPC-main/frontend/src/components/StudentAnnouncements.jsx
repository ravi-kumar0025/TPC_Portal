            ...
            <div className="flex flex-col items-center justify-center h-[70vh] text-center max-w-md mx-auto animate-[fade-in-up_0.5s_ease-out]">
                ...
                <p className="text-slate-500 dark:text-slate-300 mb-8 leading-relaxed">
                    {user?.verificationStatus === 'unsubmitted'
                        ? 'You must send a verification request from the "Verify Yourself" tab. Once verified by the CCDC, you will be able to access your branch announcements.'
                        : 'Your student profile is currently being verified by the Career Counseling and Development Centre. Access to your branch announcements will be granted once verified.'}
                </p>
            </div>
        );
    }
