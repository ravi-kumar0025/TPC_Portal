            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 space-y-32">
                ...
                <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
                    ...
                    <div className="w-full lg:w-5/12 space-y-6">
                        ...
                        <p className="text-lg text-gray-600 font-light leading-relaxed dark:text-slate-400">
                            We take pride in our 93.5% overall placement conversion rate. The Career Counseling and Development Centre works relentlessly to match every eligible candidate with roles that align with their technical expertise and career trajectory.
                        </p>
                    </div>
                </div>
