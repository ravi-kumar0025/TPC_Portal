            ...
            <div className="max-w-md w-full">
                <div className="bg-white rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-gray-100 animate-[fade-in-up_0.5s_ease-out]">
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-3 text-slate-500 font-medium">Log in to your TPC account</p>
                    </div>
                    ...
                    <div className="mt-6 pt-6 border-t border-slate-100 text-center">
                        <Link to="/signup" className="text-sm font-semibold text-slate-600 hover:text-blue-600 transition-colors">
